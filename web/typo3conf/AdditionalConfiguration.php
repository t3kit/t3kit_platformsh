...
if ($relationships) {
    ...
    foreach ($relationships['database'] as $endpoint) {
        ...
        $GLOBALS['TYPO3_CONF_VARS']['DB']['host'] = $endpoint['host'];
        $GLOBALS['TYPO3_CONF_VARS']['DB']['port'] = $endpoint['port'];
        $GLOBALS['TYPO3_CONF_VARS']['DB']['dbname'] = $endpoint['path'];
        $GLOBALS['TYPO3_CONF_VARS']['DB']['user'] = $endpoint['username'];
        $GLOBALS['TYPO3_CONF_VARS']['DB']['password'] = $endpoint['password'];
    }
/*
    $redisHost = "";
    $redisPort = "";
